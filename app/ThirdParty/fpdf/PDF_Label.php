...
//
// March 28th, 2022. Fernando Carrillo Silva.  
// modified function Add_Label() to print an image in each label
// specifically tailored for printing controlm3.com truck's labels
//
//
...
class PDF_Label extends FPDF {
	...
	protected $_Avery_Labels = array(
		'5160' => array('paper-size'=>'letter',	'metric'=>'mm',	'marginLeft'=>5,	'marginTop'=>10.7,		'NX'=>3,	'NY'=>10,	'SpaceX'=>1,	'SpaceY'=>0,	'width'=>66,	'height'=>50,		'font-size'=>9),
		...
		'5163' => array('paper-size'=>'letter',	'metric'=>'mm',	'marginLeft'=>1.762,	'marginTop'=>10.7, 		'NX'=>3,	'NY'=>5,	'SpaceX'=>1,	'SpaceY'=>0,	'width'=>101.6,		'height'=>50.8,		'font-size'=>8),
	...
	function __construct($format, $unit, $posX, $posY) {
	...
	// Print a label
	//--------------------------------------------------------------------------------------------------------
	// added parameter $imagen (image file to print)
	//--------------------------------------------------------------------------------------------------------
	function Add_Label($text,$imagen="") {
		$this->_COUNTX++;
		...
		//--------------------------------------------------------------------------------------------------------
		// print image before printing text
		//--------------------------------------------------------------------------------------------------------
		if( $imagen!=""){
			$this->Image($imagen, $_PosX, $_PosY, $this->_Height*.95);					
		}
		//----------/------------------------------------------------------------------------------------------------------------
